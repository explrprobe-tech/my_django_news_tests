...
class TestCategoryAdd:
    ...
    def test_category_add_page(self, request, category_add_page, login_page, user):
    ...
    def test_user_category_add(self, request, category_add_page, login_page, category_data, object_helper, user):
