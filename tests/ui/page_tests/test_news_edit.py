...
def test_news_edit_page(request, news_edit_page, login_page, user):
...
def test_news_edit(request, news_edit_page, login_page, test_news, test_category, news_data, user):
