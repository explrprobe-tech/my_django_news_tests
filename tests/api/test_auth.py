...
class TestAuth:
    ...
    def test_register(self, auth_api, object_helper):
    ...
    def test_delete_user_permision(self, request, test_user, user_api, session_name, expected_status, allow_redirects):
    ...
    def test_login_user(self, request, auth_api, session_name, expected_status, user_fixture, ):
    ...
    def test_logout_user(self, request, user_api, session_name):
        """Any user log-out"""
        session = request.getfixturevalue(session_name)
        user_api.set_session(session)
