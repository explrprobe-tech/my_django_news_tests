...
class TestCategories:
    ...
    def test_get_categories(self, request, category_api, session_name):
    ...
    def test_get_news_by_category(self, request, category_api, test_category, session_name):
    ...
    def test_create_category(self, request, category_api, category_data, object_helper, session_name, expected_status, msg_err):
    ...
    def test_delete_category(self, request, category_api, test_category, session_name, expected_status, allow_redirects):
        """Only Admin and Editor users can create category"""
        session = request.getfixturevalue(session_name)
        category_api.set_session(session)
