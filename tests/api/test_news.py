...
class TestNews:
    ...
    def test_get_news(self, request, news_api, session_name):
    ...
    def test_get_news_by_id(self, request, news_api, test_news, session_name):
    ...
    def test_create_news(self, request, news_api, news_data, session_name, expected_status, msg_err):
    ...
    def test_edit_news(self, request, news_api, test_news, news_data, session_name, expected_status, msg_err):
        session = request.getfixturevalue(session_name)
        news_api.set_session(session)
    ...
    def test_delete_news(self, request, news_api, test_news, session_name, expected_status, msg_err, allow_redirects):
